...
export default function customerSeeMore() {
  const dispatch = useDispatch();
  const { customerLikeYouSeeMoreData, userInfoData, cartInfoData } =
    useSelector((state) => ({
      ...state.products,
    }));
  useEffect(() => {
    dispatch(customerLikeYouSeeMore());
    dispatch(userInfo());
  }, [dispatch]);

  const inventoryWatchListData = customerLikeYouSeeMoreData;
  ...
  return (
    <SafeAreaView style={styles.safeAreaContainer}>
      ...
      <View style={styles.heading}>
        <Text style={styles.headingText}>Purchased By Customers Like You</Text>
      </View>
